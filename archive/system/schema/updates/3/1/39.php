<?php
/**
 * This update assures that all existing fields of type=fkey, fkey_multi, object and object_multi are denormalized in the object table
 *
...
$query .= " and app_object_types.name = 'dashboard';"; // lets denormalize dashboard fields
