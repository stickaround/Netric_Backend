...
CAntObjectImpWizard.prototype.save = function()
{
	if (this.save_template_name)
	{
        ...
        ajax.exec("/legacy/objects/xml_import_actions.php", args);
	}
	else
	{
		this.m_dlg.hide();
...
CAntObjectImpWizard.prototype.loadTemplates = function()
{
	...
	var url = "/legacy/objects/xml_import_actions.php?function=get_templates&obj_type="+this.mainObject.name;
	ajax.exec(url);
}
...
CAntObjectImpWizard.prototype.deleteTemplates = function(cbTemplates)
{
    ...
    ajax.exec("/legacy/email/xml_import_actions.php", args);
}
