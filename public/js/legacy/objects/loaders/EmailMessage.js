...
{	
	if (this.loaderCls.fThreadView)
	{
		...
		infocon.innerHTML = "<table>"
						  ...
						  + "<tr><td>more:</td><td>"
						  + "<a href='/legacy/email/message_view_original.awp?mid="+this.oid+"' target='_blank'>original message</a></td></tr>"
						  + "</table>";
		...
		var btn = new CButton("Print", function(cls){ window.open("/legacy/print/engine.php?obj_type=email_message&&format=html&objects[]="+cls.oid); }, [this], "b1 small");
		btn.print(td);
