...
AntAppDash.prototype.loadWidgets = function(con)
{
    ...
    ajax.exec("/legacy/applications/xml_getwidgets.awp?appNavname=" + this.appNavname);
}
...
{    
    ...
    ajax.exec("/legacy/applications/xml_getwidgets.awp?eid=" + eid + "&appNavname=" + this.appNavname);
}
/**
