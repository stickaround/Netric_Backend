{
	...
	save:function()
	{
		...
		var rpc = new CAjaxRpc("/legacy/project/xml_actions.php", "save_members", args, funct, [this], AJAX_POST);
	},
	...
	getPositions:function()
	{
		...
		//ALib.m_debug = true;
		//AJAX_TRACE_RESPONSE = true;
		var rpc = new CAjaxRpc("/legacy/project/xml_actions.php", "get_positions", [["project_id", this.mainObject.id]], funct, [this]);
	},
	...
	load:function()
	{
		...
		//ALib.m_debug = true;
		//AJAX_TRACE_RESPONSE = true;
		var rpc = new CAjaxRpc("/legacy/project/xml_actions.php", "get_members", [["project_id", this.mainObject.id]], funct, [this]);
	},
	...
	printPosition:function(id, name)
	{
		...
		a.onclick = function()
		{
			...
			dlg.onConfirmOk = function()
			{
				...
				//ALib.m_debug = true;
				//AJAX_TRACE_RESPONSE = true;
				var rpc = new CAjaxRpc("/legacy/project/xml_actions.php", "position_delete",
	...
	newPosition:function()
	{
		...
		dlg.onPromptOk = function(name, cls)
		{
			if (name)
			{
				...
				//ALib.m_debug = true;
				//AJAX_TRACE_RESPONSE = true;
				var rpc = new CAjaxRpc("/legacy/project/xml_actions.php", "position_add",
