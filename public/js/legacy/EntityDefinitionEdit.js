...
Ant.EntityDefinitionEdit.prototype.newForm = function(type)
{
	if(type == "team")
	{
		var url = "/legacy/objects/form_editor.php?obj_type="+this.obj_type+"&scope=Team";
		window.open(url, "", "fullscreen=yes");
	}
	if(type == "user")
	{
		var url = "/legacy/objects/form_editor.php?obj_type="+this.obj_type+"&scope=User";
		window.open(url, "", "fullscreen=yes");
	}
}
...
Ant.EntityDefinitionEdit.prototype.createFrmTbl = function(forms)
{
	for(form in forms)
	{
		...
		{
			var form_url = "/legacy/objects/form_editor.php?obj_type="+this.cls.obj_type;
...
Ant.EntityDefinitionEdit.prototype.addDefaultForms = function()
{
	...
	if(!this.default_form)
	{
		...
		form_lnk.onclick = function()
		{
			var form_url = "/legacy/objects/form_editor.php?obj_type="+this.cls.obj_type+"&scope=Default";
			window.open(form_url, "", "fullscreen=yes");
		}
		row.addCell(edit_frm);
		row.addCell("");
	...
	if(!this.default_mobile_form)
	{
		...
		form_lnk.onclick = function() 
		{
			var form_url = "/legacy/objects/form_editor.php?obj_type="+this.cls.obj_type+"&scope=Mobile&mobile=0";
			window.open(form_url, "", "fullscreen=yes");
		}
		row.addCell(edit_frm);
		row.addCell("");
