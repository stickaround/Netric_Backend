 ...
 *
 * <code>
 * 	var wiz = new AntWizard("WizardName");
...
*
*****************************************************************************/
function UpdateEditionWizard(userid)
{
	this.userId = userid;
...
**************************************************************************/
UpdateEditionWizard.prototype.showDialog = function(parentDlg)
{
...
**************************************************************************/
UpdateEditionWizard.prototype.showStep = function(step)
{
...
**************************************************************************/
UpdateEditionWizard.prototype.veriftyStep = function()
{
	return true;
}
...
**************************************************************************/
UpdateEditionWizard.prototype.cancel = function()
{
...
*	Purpose:	This function should be over-rideen
**************************************************************************/
UpdateEditionWizard.prototype.onCancel = function()
{
}
...
*	Purpose:	This function should be over-rideen
**************************************************************************/
UpdateEditionWizard.prototype.onFinished = function()
{
}
...
**************************************************************************/
UpdateEditionWizard.prototype.save = function()
{
	this.m_dlg.hide();
...
**************************************************************************/
UpdateEditionWizard.prototype.testCcard = function()
{
	...
	var ajax = new CAjax();
	var url = "/legacy/objects/xml_get_objectdef.php?function=renew_test_ccard";
...
**************************************************************************/
UpdateEditionWizard.prototype.addObject = function(oid)
{
...
**************************************************************************/
UpdateEditionWizard.prototype.buildFrmData = function(con)
{
...
**************************************************************************/
UpdateEditionWizard.prototype.setFieldUse = function(field_name, oid)
{
...
**************************************************************************/
UpdateEditionWizard.prototype.getFieldUse = function(field_name)
{
	for (var i = 0; i < this.fields.length; i++)
	{
		if (this.fields[i].name == field_name)
