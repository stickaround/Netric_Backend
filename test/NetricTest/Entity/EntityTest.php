    ...
    protected function setUp(): void
{
    ...
    /**
     * Test default timestamp on update
     */
    public function testFieldDefaultTimestampOnUpdate()
    {
        $cust = $this->account->getServiceManager()->get(EntityLoaderFactory::class)->create(ObjectTypes::CONTACT);
        $cust->setValue("name", "testFieldDefaultTimestamp");
        $cust->setFieldsDefault('update'); // time_created has a 'now' on 'update' default
