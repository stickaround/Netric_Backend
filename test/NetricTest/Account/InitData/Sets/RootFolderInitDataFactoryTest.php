...
use Netric\Account\InitData\Sets\RootFolderInitData;
 ...
 * @group integration
 */
class RootFolderInitDataFactoryTest extends TestCase
{
    /**
    ...
    public function testSetInitialData()
    {
        ...
        $this->assertInstanceOf(RootFolderInitData::class, $dataSet);
    }
}
