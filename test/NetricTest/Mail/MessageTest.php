...
class MessageTest extends TestCase
{
    ...
    public function testSetsOrigDateHeaderByDefault()
    {
        ...
        $this->assertInstanceOf('Netric\Mail\Headers', $headers);
    ...
    public function testCcMethodReturnsAddressListObject()
    {
        ...
        $this->assertInstanceOf('Netric\Mail\AddressList', $cc);
    }
    ...
    public function testBccMethodReturnsAddressListObject()
    {
        ...
        $this->assertInstanceOf('Netric\Mail\AddressList', $bcc);
    }
    ...
    public function testReplyToMethodReturnsAddressListObject()
    {
        ...
        $this->assertInstanceOf('Netric\Mail\AddressList', $replyTo);
    }
    ...
    {
        $object = new Fixture\StringSerializableObject('body');
    ...
    public function testHeaderUnfoldingWorksAsExpectedForMultipartMessages()
    {
        ...
        $text->setEncoding(Mime::ENCODING_QUOTEDPRINTABLE);
        $text->setDisposition(Mime::DISPOSITION_INLINE);
        ...
        $html->setDisposition(Mime::DISPOSITION_INLINE);
