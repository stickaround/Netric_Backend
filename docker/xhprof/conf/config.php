...
$_xhprof = array();
// Change these:
$_xhprof['dbtype'] = 'pgsql'; // Only relevant for PDO
$_xhprof['dbhost'] = 'db1';
$_xhprof['dbuser'] = 'vagrant';
$_xhprof['dbpass'] = 'vagrant';
$_xhprof['dbname'] = 'xhprof';
$_xhprof['dbadapter'] = 'Pdo';
$_xhprof['servername'] = 'db1';
$_xhprof['namespace'] = 'netric';
$_xhprof['url'] = 'http://xhprof/xhprof_html';
/*
