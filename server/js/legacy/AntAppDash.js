...
* @depricated This has been removed, the object dashboard loader now handles all dashboards, both custom and application. -Sky Stebnicki
*
...
AntAppDash.prototype.loadWidgets = function(con)
{
    ...
    ajax.exec("/public/legacy/applications/xml_getwidgets.awp?appNavname=" + this.appNavname);
}
...
{    
    ...
    ajax.exec("/public/legacy/applications/xml_getwidgets.awp?eid=" + eid + "&appNavname=" + this.appNavname);
}
/**
