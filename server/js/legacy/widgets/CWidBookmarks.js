...
CWidBookmarks.prototype.loadBookmarks = function()
{
	...
	this.ajax.exec("/public/legacy/widgets/xml_bookmarks.php?function=get_bookmarks");
}
...
CWidBookmarks.prototype.insertCategory = function(name, id, tvnode)
{
	...
	{
		var xmlrpc = new CAjaxRpc("/public/legacy/widgets/xml_bookmarks.php", "rename_category",
...
CWidBookmarks.prototype.deleteBookmark = function(tvnode, bid)
{
	...
	{
		var xmlrpc = new CAjaxRpc("/public/legacy/widgets/xml_bookmarks.php", "delete_bookmark",
							  	  [["bid", bid]], 
...
CWidBookmarks.prototype.deleteCategory = function(tvnode, cid)
{
	...
	{
		var xmlrpc = new CAjaxRpc("/public/legacy/widgets/xml_bookmarks.php", "delete_category",
							  	  [["catid", cid]], 
								  function(ret, tvnode){ tvnode.remove();}, [tvnode]);
	}
}
...
CWidBookmarks.prototype.editBookmark = function(name, url, cid, bid, tvnode)
{
	...
	var widcls = this;
	var xmlrpc = new CAjaxRpc("/public/legacy/widgets/xml_bookmarks.php", "edit_bookmark",
...
CWidBookmarks.prototype.addCategory = function(pcid, tvnode)
{
	...
	var widcls = this;
	var xmlrpc = new CAjaxRpc("/public/legacy/widgets/xml_bookmarks.php", "add_category",
