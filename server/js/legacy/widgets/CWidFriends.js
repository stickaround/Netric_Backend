...
CWidFriends.prototype.changeMyName = function()
{
	...
	if (name && name!='null' && name!='undefined')
	{
		...
		var xmlrpc = new CAjaxRpc("/public/legacy/contacts/xml_friends_status.awp", "setname",
								  [["myname", name]], funct);
	}
}
...
CWidFriends.prototype.setMyStatus = function(stat)
{
	...
	if (stat)
	{
		var xmlrpc = new CAjaxRpc("/public/legacy/contacts/xml_friends_status.awp", "setstatus",
...
{
	var xmlrpc = new CAjaxRpc("/public/legacy/contacts/xml_friends_status.awp", "getmystatus",
