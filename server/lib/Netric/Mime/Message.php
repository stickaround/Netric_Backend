...
class Message
{
    ...
    /**
     * Returns the list of all Netric\Mime\Part in the message
     *
     * @return array of \Netric\Mime\Part
     */
    ...
    /**
     * Sets the given array of Netric\Mime\Part as the array for the message
     *
     * @param array $parts
     */
    ...
    /**
     * Append a new Netric\Mime\Part to the current message
     *
     * @param \Netric\Mime\Part $part
     */
    ...
    /**
     * Set Netric\Mime\Mime object for the message
     *
     * This can be used to set the boundary specifically or to use a subclass of
     * Netric\Mime for generating the boundary.
     *
     * @param \Netric\Mime\Mime $mime
     */
     ...
     *
     * Parts are separated by the mime boundary as defined in Netric\Mime\Mime. If
     * {@link setMime()} has been called before this method, the Netric\Mime\Mime
     * object set by this call will be used. Otherwise, a new Netric\Mime\Mime object
     * is generated and used.
     *
     * @param string $EOL EOL string; defaults to {@link Netric\Mime\Mime::LINEEND}
     * @return string
     */
    ...
    /**
     * Decodes a MIME encoded string and returns a Netric\Mime\Message object with
    ...
    public static function createFromMessage($message, $boundary, $EOL = Mime::LINEEND)
    {
        ...
        foreach ($parts as $part) {
            ...
            foreach ($part['header'] as $header) {
                /** @var \Netric\Mail\Header\HeaderInterface $header */
                /**
