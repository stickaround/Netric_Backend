...
abstract class AbstractProtocol
{
    ...
    /**
     * Instance of Netric\Validator\ValidatorChain to check hostnames
     ...
     * Throws a Netric\Mail\Protocol\Exception\ExceptionInterface if an unexpected code is returned.
     *
