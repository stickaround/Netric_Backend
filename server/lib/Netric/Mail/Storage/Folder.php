...
{
    /**
     * subfolders of folder array(localName => \Netric\Mail\Storage\Folder folder)
     * @var array
     */
    protected $folders;
     ...
     * @param array  $folders    init with given instances of \Netric\Mail\Storage\Folder as subfolders
     */
     ...
     *
     * @return \Netric\Mail\Storage\Folder same as self::current()
     */
     ...
     *
     * @return \Netric\Mail\Storage\Folder current folder
     */
     ...
     * @return \Netric\Mail\Storage\Folder folder named $folder
     */
     ...
     * @param \Netric\Mail\Storage\Folder $folder instance for new subfolder
     */
