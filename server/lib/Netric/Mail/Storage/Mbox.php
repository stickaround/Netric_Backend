...
class Mbox extends AbstractStorage
{
     ...
     * @var string
     */
    protected $messageClass = '\Netric\Mail\Storage\Message\File';
     ...
     *
     * @param  int $id number of message
     * @return \Netric\Mail\Storage\Message\File
     * @throws \Netric\Mail\Storage\Exception\ExceptionInterface
     */
    public function getMessage($id)
    {
        // TODO that's ugly, would be better to let the message class decide
        if (strtolower($this->messageClass) == '\netric\mail\storage\message\file'
            || is_subclass_of($this->messageClass, '\Netric\Mail\Storage\Message\File')) {
            // TODO top/body lines
