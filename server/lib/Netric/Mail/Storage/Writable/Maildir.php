...
use Netric\Mail\Exception as MailException;
use Netric\Mail\Storage;
use Netric\Mail\Storage\Exception as StorageException;
use Netric\Mail\Storage\Folder;
...
class Maildir extends Folder\Maildir implements WritableInterface
{
     ...
     * @throws \Netric\Mail\Storage\Exception\RuntimeException
     */
    // not yet * @param string|\Netric\Mail\Message|\Netric\Mime\Message $message message as string or instance of message class
     ...
     * @param  string|\Netric\Mail\Storage\Folder $folder name or instance of targer folder
     * @throws \Netric\Mail\Storage\Exception\RuntimeException
     */
     ...
     *
     * @see \Netric\Mail\Storage\Writable\Maildir::setQuota()
