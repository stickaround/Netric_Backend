...
$schema['activity'] = array(
	"COLUMNS" => array(
		...
		'direction'		=> array('type'=>'character(1)'),
	...
	"KEYS" => array(
		...
		'ts_entered'	=> array("INDEX", "ts_entered"),
	)
);
*/

$schema['activity_types'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
...
/*
$schema['app_local_query_cache'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'ts_entered'	=> array('type'=>'timestamp without time zone'),
...
$schema['app_object_field_defaults'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['app_object_field_options'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'field_id'		=> array('type'=>'integer', 'notnull'=>true),
...
$schema['app_object_imp_maps'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['app_object_imp_templates'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'type_id'		=> array('type'=>'integer'),
		'name'			=> array('type'=>'character varying(256)'),
...
$schema['app_object_list_cache'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['app_object_list_cache_flds'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['app_object_list_cache_res'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'list_id'		=> array('type'=>'integer'),
...
$schema['app_object_type_fields'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'type_id'		=> array('type'=>'integer'),
...
$schema['app_object_type_frm_layouts'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'type_id'		=> array('type'=>'integer'),
...
$schema['app_object_view_conditions'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['app_object_view_fields'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'view_id'		=> array('type'=>'integer'),
		'field_id'		=> array('type'=>'integer'),
...
$schema['app_object_view_orderby'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'view_id'		=> array('type'=>'integer'),
		'field_id'		=> array('type'=>'integer'),
...
$schema['application_calendars'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['application_objects'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'application_id'=> array('type'=>'integer', 'notnull'=>true),
...
$schema['calendar_event_coord'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'notes'			=> array('type'=>'text'),
...
$schema['calendar_event_coord_times'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['calendar_event_coord_att_times'] = array(
	"COLUMNS" => array(
		'att_id'		=> array('type'=>'integer'),
		'time_id'		=> array('type'=>"integer"),
		'response'		=> array('type'=>"integer"),
...
$schema['calendar_events_reminders'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['chat_queue_agents'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['chat_queue_entries'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
...
$schema['chat_server_session'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'user_name'		=> array('type'=>'character varying(256)'),
...
/*
$schema['contacts_personal'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		...
		'salutation'	=> array('type'=>'character varying(128)'),
		'spouse_name'	=> array('type'=>'character varying(128)'),
		'phone_home'	=> array('type'=>'character varying(128)'),
		'phone_work'	=> array('type'=>'character varying(128)'),
		'phone_cell'	=> array('type'=>'character varying(128)'),
		'phone_other'	=> array('type'=>'character varying(128)'),
		...
		'city'			=> array('type'=>'character varying(64)'),
		'zip'			=> array('type'=>'character varying(16)'),
		'last_contacted'=> array('type'=>'date'),
		'date_entered'	=> array('type'=>'date'),
		'date_changed'	=> array('type'=>'timestamp with time zone'),
		'ts_entered'	=> array('type'=>'timestamp with time zone'),
		'ts_changed'	=> array('type'=>'timestamp with time zone'),
		'user_id'		=> array('type'=>'integer'),
		'notes'			=> array('type'=>'text'),
		'job_title'		=> array('type'=>'character varying(128)'),
		'company'		=> array('type'=>'character varying(256)'),
		'fax'			=> array('type'=>'character varying(16)'),
		'pager'			=> array('type'=>'character varying(16)'),
		'website'		=> array('type'=>'character varying(128)'),
		'nick_name'		=> array('type'=>'character varying(128)'),
		'ext'			=> array('type'=>'character varying(16)'),
		'phone_fax'		=> array('type'=>'character varying(32)'),
		'phone_pager'	=> array('type'=>'character varying(32)'),
		...
		'business_website'=> array('type'=>'character varying(128)'),
		'email_default'	=> array('type'=>'character varying(16)'),
		'anniversary'	=> array('type'=>'date'),
		'anniversary_evnt'=> array('type'=>'integer'),
		'birthday_spouse'=> array('type'=>'date'),
		'birthday_spouse_evnt'=> array('type'=>'integer'),
		'birthday'=> array('type'=>'date'),
		'birthday_evnt'=> array('type'=>'integer'),
	...
	"KEYS" => array(
		'user_id'		=> array("INDEX", "user_id"),
		'date_changed'		=> array("INDEX", "date_changed"),
	)
);
 */

$schema['contacts_personal_labels'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
...
$schema['contacts_personal_label_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['customer_association_types'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(64)'),
...
$schema['customer_associations'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'parent_id'		=> array('type'=>'integer'),
		'customer_id'	=> array('type'=>'integer'),
...
$schema['customer_invoice_templates'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(512)'),
...
$schema['customer_invoices'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['customer_invoice_detail'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['customer_invoice_status'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint'),
...
$schema['customer_label_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'customer_id'	=> array('type'=>'integer'),
		'label_id'		=> array('type'=>'integer'),
...
$schema['customer_lead_status'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
...
$schema['customer_lead_sources'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['customer_lead_rating'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['customer_lead_classes'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['customer_lead_queues'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['customer_objections'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'description'	=> array('type'=>'text'),
...
$schema['customer_opportunities'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'owner_id'		=> array('type'=>'integer'),
		'ts_entered'	=> array('type'=>'timestamp with time zone'),
...
$schema['customer_opportunity_stages'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['customer_opportunity_types'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'sort_order'	=> array('type'=>'smallint', 'default'=>'0'),
...
$schema['email_video_message_themes'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)', 'notnull'=>true),
...
$schema['email_settings_spam'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
...
/*
$schema['email_signatures'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(32)', 'notnull'=>true),
		'content_type'	=> array('type'=>'character varying(32)'),
		'signature'		=> array('type'=>'text'),
		'user_id'		=> array('type'=>'integer'),
		'use_default'	=> array('type'=>'boolean', "default"=>"false"),
	),
	'PRIMARY_KEY'		=> 'id',
	"KEYS" => array(
		'user_id'		=> array("INDEX", "user_id", "users", "id"),
...
/*
$schema['email_messages'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'mailbox_id'	=> array('type'=>'integer'),
		'message_id'	=> array('type'=>'character varying(256)'),
		'cc'			=> array('type'=>'text'),
		'reply_to'		=> array('type'=>'character varying(128)'),
		'priority'		=> array('type'=>'character varying(16)'),
		'flag_seen'		=> array('type'=>'boolean', "default"=>"false"),
		'flag_draft'	=> array('type'=>'boolean', "default"=>"false"),
		'flag_answered'	=> array('type'=>'boolean', "default"=>"false"),
		'flag_flagged'	=> array('type'=>'boolean', "default"=>"false"),
		'flag_spam'		=> array('type'=>'boolean', "default"=>"false"),
		'spam_status'	=> array('type'=>'text'),
		'spam_report'	=> array('type'=>'text'),
		'content_type'	=> array('type'=>'character varying(256)'),
		'body_type'		=> array('type'=>'character varying(32)'),
		'send_to'		=> array('type'=>'text'),
		'sent_from'		=> array('type'=>'text'),
		'subject'		=> array('type'=>'text'),
		'return_path'	=> array('type'=>'character varying(256)'),
		'in_reply_to'	=> array('type'=>'character varying(256)'),
		'thread'		=> array('type'=>'bigint'),
		'orig_header'	=> array('type'=>'text'),
		'message_size'	=> array('type'=>'integer'),
		'file_id'		=> array('type'=>'integer'),
		'num_attachments'=> array('type'=>'integer'),
		'thread_count'	=> array('type'=>'integer', 'default'=>'1'),
		'keywords'		=> array('type'=>'text'),
		'message_date'	=> array('type'=>'timestamp with time zone'),
		'ts_updated'	=> array('type'=>'timestamp with time zone'),
		'bcc'			=> array('type'=>'text'),
		'body'			=> array('type'=>'text'),
		'parse_rev'		=> array('type'=>'smallint', 'default'=>'0'),
		'owner_id'		=> array('type'=>'integer'),
		'f_deleted'		=> array('type'=>'boolean', "default"=>"false"),
		'revision'		=> array('type'=>'integer'),
		'path'			=> array('type'=>'text'),
        'uname'         => array('type'=>'character varying(256)'),
		'message_uid'	=> array('type'=>'character varying(128)'),
	),
	'PRIMARY_KEY'		=> 'id',
	"KEYS" => array(
		'mailbox_id'	=> array("FKEY", "mailbox_id", "email_mailboxes", "id"),
		'owner_id'		=> array("FKEY", "owner_id", "users", "id"),
		'message_date'	=> array("INDEX", "message_date"),
		'message_uid'	=> array("INDEX", "message_uid"),
	)
);

$schema['email_message_attachments'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'message_id'	=> array('type'=>'integer'),
		'content_type'	=> array('type'=>'character varying(256)'),
		'encoding'		=> array('type'=>'character varying(64)'),
		'disposition'	=> array('type'=>'character varying(128)'),
		'filename'		=> array('type'=>'character varying(128)'),
		'boundary'		=> array('type'=>'character varying(512)'),
		'attached_data'	=> array('type'=>'text'),
		'header'		=> array('type'=>'text'),
		'body'			=> array('type'=>'bytea'),
		'size'			=> array('type'=>'bigint'),
		'offset_start'	=> array('type'=>'bigint'),
		'offset_end'	=> array('type'=>'bigint'),
		'name'			=> array('type'=>'character varying(512)'),
		'content_id'	=> array('type'=>'character varying(128)'),
		'parent_id'		=> array('type'=>'bigint'), // possible parent attachment
	...
	'PRIMARY_KEY'		=> 'id',
	"KEYS" => array(
		'message_id'	=> array("INDEX", "message_id", "email_messages", "id"),
		'content_type'	=> array("INDEX", "content_type"),
	)
);
 */

$schema['email_message_original'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['email_message_queue'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'lo_message'	=> array('type'=>'oid'),
...
/*
$schema['email_threads'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'subject'		=> array('type'=>'text'),
		'body'			=> array('type'=>'text'),
		'senders'		=> array('type'=>'text'),
		'receivers'		=> array('type'=>'text'),
		'keywords'		=> array('type'=>'text'),
		'time_updated'	=> array('type'=>'timestamp with time zone'),
		'ts_delivered'	=> array('type'=>'timestamp with time zone'),
		'num_attachments'=> array('type'=>'smallint', 'default'=>'0'),
		'num_messages'	=> array('type'=>'smallint', 'default'=>'0'),
		'f_seen'		=> array('type'=>'boolean', "default"=>"false"),
		'f_bodycached'	=> array('type'=>'boolean', "default"=>"false"),
		'f_processed'	=> array('type'=>'boolean', "default"=>"false"),
		'f_flagged'		=> array('type'=>'boolean', "default"=>"false"),
		'owner_id'		=> array('type'=>'integer'),
		'f_deleted'		=> array('type'=>'boolean', "default"=>"false"),
		'revision'		=> array('type'=>'integer'),
		'path'			=> array('type'=>'text'),
	...
	"KEYS" => array(
		'owner_id'		=> array("FKEY", "owner_id", "users", "id"),
		'email_threads_timeup_idx'	=> array("INDEX", "time_updated"),
		'email_threads_timedel_idx'	=> array("INDEX", "ts_delivered"),
		'owner_id'		=> array("FKEY", "owner_id", "users", "id"),
	)
);
*/

$schema['email_thread_mailbox_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['email_video_messages'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'file_id'		=> array('type'=>'bigint'),
...
$schema['favorites_categories'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
		'user_id'		=> array('type'=>'integer'),
...
$schema['ic_document_group_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
 ...
 */
$schema['object_associations'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'type_id'		=> array('type'=>'integer'),
...
$schema['object_index_cachedata'] = array(
	"COLUMNS" => array(
		'object_type_id'=> array('type'=>'integer', 'notnull'=>true),
		'object_id'		=> array('type'=>'bigint', 'notnull'=>true),
		'revision'		=> array('type'=>'integer'),
...
$schema['object_index_fulltext'] = array(
	"COLUMNS" => array(
		'object_type_id'=> array('type'=>'integer', 'notnull'=>true),
		'object_id'		=> array('type'=>'bigint', 'notnull'=>true),
...
$schema['object_index_fulltext_act'] = array(
...
$schema['object_index_fulltext_del'] = array(
	'COLUMNS' => array(), // inherited
	'INHERITS' => 'object_index_fulltext',
	'PRIMARY_KEY'		=> array('object_type_id', 'object_id'),
	"CONSTRAINTS" => array(
...
$schema['object_recurrence'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['object_revision_data'] = array(
	"COLUMNS" => array(
...
$schema['object_grouping_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'object_type_id'=> array('type'=>'integer', 'notnull'=>true),
...
$schema['printing_papers_labels'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
...
$schema['product_categories'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'parent_id'		=> array('type'=>'integer'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
...
$schema['product_categories_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
 ...
 */
$schema['project_bug_severity'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
		'color'			=> array('type'=>'character varying(6)'),
...
$schema['project_bug_status'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
		'color'			=> array('type'=>'character varying(6)'),
...
$schema['project_bug_types'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
		'color'			=> array('type'=>'character varying(6)'),
...
$schema['project_templates'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(128)'),
		'notes'			=> array('type'=>'text'),
...
$schema['project_template_members'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'template_id'	=> array('type'=>'integer'),
...
$schema['project_template_share'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'template_id'	=> array('type'=>'integer'),
...
$schema['project_template_tasks'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'text'),
		'notes'			=> array('type'=>'text'),
...
$schema['project_group_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['project_positions'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
		'project_id'	=> array('type'=>'integer'),
...
$schema['project_membership'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
		'project_id'	=> array('type'=>'integer'),
...
$schema['project_milestones'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'project_id'	=> array('type'=>'integer'),
		'user_id'		=> array('type'=>'integer'),
...
$schema['sales_order_detail'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'text'),
...
$schema['sales_order_status'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'parent_id'		=> array('type'=>'integer'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
...
$schema['stocks_membership'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'bigint'),
...
$schema['user_dashboard_layout'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'subtype'=>'', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'integer'),
 ...
 */
/*
$schema['user_file_categories'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'bigint'),
		'name'			=> array('type'=>'character varying(256)'),
		'keywords'		=> array('type'=>'text'),
		'parent_id'		=> array('type'=>'bigint'),
		'view_mode'		=> array('type'=>'integer'),
		'dacl_read_files'=> array('type'=>'bigint'),
		'dacl_read_folders'=> array('type'=>'bigint'),
		'dacl_create_files'=> array('type'=>'bigint'),
		'dacl_create_folders'=> array('type'=>'bigint'),
		'dacl_delete_files'=> array('type'=>'bigint'),
		'dacl_delete_folders'=> array('type'=>'bigint'),
		'dacl_secedit'	=> array('type'=>'bigint'),
		'f_special'		=> array('type'=>'boolean', "default"=>"false"),
		'f_deleted'		=> array('type'=>'boolean', "default"=>"false"),
	),
	'PRIMARY_KEY'		=> 'id',
...
/*
$schema['user_files'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'user_id'		=> array('type'=>'bigint'),
		'file_name'		=> array('type'=>'character varying(512)'),
		'file_title'	=> array('type'=>'character varying(512)'),
		'local_path'	=> array('type'=>'character varying(512)'),
		'time_updated'	=> array('type'=>'timestamp with time zone'),
		'file_size_old'	=> array('type'=>'real'),
		'file_type'		=> array('type'=>'character varying(32)'),
		'category_id'	=> array('type'=>'bigint'),
		'keywords'		=> array('type'=>'text'),
		'remote_file'	=> array('type'=>'character varying(256)'),
		'f_bpurged'		=> array('type'=>'boolean', "default"=>"false"),
		'revision'		=> array('type'=>'integer'),
		'f_deleted'		=> array('type'=>'boolean', "default"=>"false"),
		'f_ans_skipped'	=> array('type'=>'boolean', "default"=>"false"),
		'f_ans_cleaned'	=> array('type'=>'boolean', "default"=>"false"),
		'f_purged'		=> array('type'=>'boolean', "default"=>"false"),
		'f_temp'		=> array('type'=>'boolean', "default"=>"false"),
		'content_type'=> array('type'=>'character varying(256)'),
		'content_id'=> array('type'=>'character varying(256)'),
		'content_disposition'=> array('type'=>'character varying(128)'),
		'ans_key'		=> array('type'=>'character varying(640)'),
		'file_size'		=> array('type'=>'bigint'),
	),
	'PRIMARY_KEY'		=> 'id',
	"KEYS" => array(
		'user_id' 		=> array("INDEX", "user_id", "users", "id"),
		'category_id'	=> array("INDEX", "category_id", "user_file_categories", "id"),
	)
);
 */
/*
$schema['user_files_documents'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'file_id'		=> array('type'=>'bigint'),
		'data'			=> array('type'=>'text'),
		'margins'		=> array('type'=>'integer[]'),
	),
	'PRIMARY_KEY'		=> 'id',
	"KEYS" => array(
		'file_id' 		=> array("INDEX", "file_id", "user_files", "id"),
	)
);
 */

$schema['user_teams'] = array(
	"COLUMNS" => array(
...
$schema['user_notes_categories'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'parent_id'		=> array('type'=>'integer'),
		'user_id'		=> array('type'=>'integer'),
...
$schema['user_notes_cat_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['workflow_action_schedule'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['workflow_conditions'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['workflow_instances'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'object_type_id'=> array('type'=>'integer', 'notnull'=>true),
...
$schema['workflow_object_values'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['workflow_approvals'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
		'notes'			=> array('type'=>'text'),
...
$schema['xml_feed_group_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['xml_feed_post_categories'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'integer', 'default'=>'auto_increment'),
		'parent_id'		=> array('type'=>'integer'),
		'name'			=> array('type'=>'character varying(128)', 'notnull'=>true),
...
$schema['xml_feed_post_cat_mem'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['report_table_dims'] = array(
    "COLUMNS" => array(
        'id'            => array('type'=>'bigint', 'default'=>'auto_increment'),
        'report_id'     => array('type'=>'bigint'),
...
$schema['report_table_measures'] = array(
    "COLUMNS" => array(
        'id'            => array('type'=>'bigint', 'default'=>'auto_increment'),
        'report_id'     => array('type'=>'bigint'),
        'table_type'    => array("type"=>"character varying(32)", "notnull"=>true),
...
$schema['dashboard_widgets'] = array(
    "COLUMNS" => array(
        'id'            => array('type'=>'bigint', 'default'=>'auto_increment'),        
...
$schema['dataware_olap_cubes'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(512)'),
	),
...
$schema['dataware_olap_cube_dims'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
		'type'			=> array('type'=>'character varying(32)'),
...
$schema['dataware_olap_cube_measures'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'name'			=> array('type'=>'character varying(256)'),
		'cube_id'		=> array('type'=>'bigint'),
...
$schema['object_sync_partner_collection_init'] = array(
	"COLUMNS" => array(
...
$schema['object_sync_stats'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
...
$schema['object_sync_import'] = array(
	"COLUMNS" => array(
		'id'			=> array('type'=>'bigint', 'default'=>'auto_increment'),
		'collection_id'	=> array('type'=>'bigint'),
		'object_type_id'=> array('type'=>'integer'),
