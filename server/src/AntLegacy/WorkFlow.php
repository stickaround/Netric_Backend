...
require_once("src/AntLegacy/WorkFlow/Condition.php");
require_once("src/AntLegacy/WorkFlow/List.php");
// Workflow Actions
require_once("src/AntLegacy/WorkFlow/Action.php");
require_once("src/AntLegacy/WorkFlow/Action/Test.php");
require_once("src/AntLegacy/WorkFlow/Action/Notification.php");
require_once("src/AntLegacy/WorkFlow/Action/Invoice.php");
require_once("src/AntLegacy/WorkFlow/Action/Approval.php");
require_once("src/AntLegacy/WorkFlow/Action/CallPage.php");
require_once("src/AntLegacy/WorkFlow/Action/UpdateField.php");
require_once("src/AntLegacy/WorkFlow/Action/AssignRR.php");
...
class WorkFlow
{
	...
	public function execute($obj)
	{
		...
		for ($a = 0; $a < $this->getNumActions(); $a++)
		{
			...
			{
				/**
				 * Sky Stebnicki: We may move everything to a background process due to performance hits
