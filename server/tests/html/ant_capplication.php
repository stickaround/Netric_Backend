...
<script language="javascript" type="text/javascript">
	...
	function main()
	{
        ...
        var typeHash = window.location.hash;
        var typeParts = typeHash.split("/");
        var type = typeParts[0].replace("#", "");
        
        navMain = new AntViewsRouter();
		navMain.defaultView = type;
		...
		var homeView = navMain.options.viewManager.addView(type, {}, mainCon); // Default view is called index
        homeView.type = type;
		homeView.render = function()
		{
			var app = new AntApp(this.type);
			app.main(this);
		}
	}
