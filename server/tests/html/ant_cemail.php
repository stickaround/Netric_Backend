...
<script language="javascript" type="text/javascript">
	...
	function main()
	{
		...
		var homeView = navMain.options.viewManager.addView("email", {}, mainCon); // Default view is called index
		homeView.render = function()
		{
			var app = new AntApp("email");
			app.main(this);
		}
	}
...
<script language="javascript" type="text/javascript" src="/lib/js/Ant.js"></script>
</head>
