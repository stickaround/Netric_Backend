...
$settings_localhost_root = "localhost"; 	// Used to compare localhost for third level domain
$settings_debug = true;
$settings_debug_nomail = true; // Do not email errors
$settings_server_root = "C:/Users/Sky Stebnicki/sandbox/ant.aereus.com";
$settings_data_path = "C:/Users/Sky Stebnicki/sandbox/ant.aereus.com/data";
...
define("ANT_INDEX_ELASTIC_HOST", "localhost");
...
if (!isset($SETTINGS_NO_SESSION)) // do not use a session for web services
{
	if (isset($_SESSION["ACCOUNT"]))
		...
		$settings_account_number = "19";      // Default
}
else
	$settings_account_number = 19;
...
$SETTINGS['ans_password'] = "kryptos78";
