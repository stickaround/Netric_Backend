...
WHERE 
    field_data->'is_seen' IS NOT NULL AND
    field_data->>'is_seen'!='' AND
    f_deleted!=true;
...
UPDATE 
  ...
  WHERE field_data->>'f_seen'='true' and field_data->>'is_seen'='';

UPDATE 
    entity 
  SET 
    field_data=field_data || jsonb_build_object('is_seen', false) 
  WHERE field_data->>'f_seen'='false' and field_data->>'is_seen'='';