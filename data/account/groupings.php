...
return [
    ...
    'ticket' => [
        ...
        'priority_id' => [
            ["name" => TicketEntity::PRIORITY_LOW, "sort_oder" => 1, "color" => "1D6914"],
            ["name" => TicketEntity::PRIORITY_MEDIUM, "sort_oder" => 2, "color" => "575757"],
            ["name" => TicketEntity::PRIORITY_HIGH, "sort_oder" => 3, "color" => "AD2323"],
        ],
        'source_id' => [
