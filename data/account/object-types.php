...
return [
    ...
    ["obj_type" => "case", "title" => "Case", "revision" => "0", "system" => true],
    ...
    ["obj_type" => "project_story", "title" => "Issue", "revision" => "0", "system" => true], // TODO: We should remove this on the next release.
