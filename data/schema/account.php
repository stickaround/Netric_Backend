...
return array(
    ...
    "app_object_types" => array(
        "PROPERTIES" => array(
            ...
            'is_private' => array('type' => SchemaProperty::TYPE_BOOL, "default" => "false"),
            'store_revisions' => array('type' => SchemaProperty::TYPE_BOOL, "default" => "true"),
            'recur_rules' => array('type' => SchemaProperty::TYPE_CHAR_TEXT),
            'inherit_dacl_ref' => array("type" => SchemaProperty::TYPE_CHAR_128),
            'parent_field' => array("type" => SchemaProperty::TYPE_CHAR_128),
            'uname_settings' => array("type" => SchemaProperty::TYPE_CHAR_256),
            'list_title' => array("type" => SchemaProperty::TYPE_CHAR_128),
            'icon' => array("type" => SchemaProperty::TYPE_CHAR_128),
            'default_activity_level' => array('type' => SchemaProperty::TYPE_INT),
        ),
        'PRIMARY_KEY' => 'id',
        "INDEXES" => array(
    ...
    "objects" => array(
        "PROPERTIES" => array(
            ...
            'commit_id' => array('type' => SchemaProperty::TYPE_BIGINT),
            'data' => array('type' => SchemaProperty::TYPE_JSON),
        )
    ),
