 ...
 *
 */
class SendEmailActionExecutor extends AbstractActionExecutor implements ActionInterface
{
    /**
     ...
     */
    public function __construct(EntityLoader $entityLoader, ActionExecutorFactory $actionFactory, SenderService $senderService)
    {
