...
use Netric\Mail\Storage\Exception;
use Netric\Stdlib\ErrorHandler;

class Mbox extends Storage\Mbox implements FolderInterface
{
    /**
     * \Netric\Mail\Storage\Folder root folder for folder structure
     * @var \Netric\Mail\Storage\Folder
     */
     ...
     *   - filename use \Netric\Mail\Storage\Mbox for a single file
     * Supported parameters are:
     *   - dirname rootdir of mbox structure
     *   - folder intial selected folder, default is 'INBOX'
     *
     * @param  $params array mail reader specific parameters
     * @throws \Netric\Mail\Storage\Exception\InvalidArgumentException
     */
    public function __construct($params)
    {
        ...
        if (isset($params->filename)) {
            throw new Exception\InvalidArgumentException('use \Netric\Mail\Storage\Mbox for a single file');
        }
     ...
     *
     * Result is save in \Netric\Mail\Storage\Folder instances with the root in $this->rootFolder.
     * $parentFolder and $parentGlobalName are only used internally for recursion.
     *
     * @param string $currentDir call with root dir, also used for recursion.
     * @param \Netric\Mail\Storage\Folder|null $parentFolder used for recursion
     ...
     * @throws \Netric\Mail\Storage\Exception\InvalidArgumentException
     * @return \Netric\Mail\Storage\Folder root or wanted folder
     */
     ...
     *
     * @param \Netric\Mail\Storage\Folder|string $globalName global name of folder or instance for subfolder
     * @throws \Netric\Mail\Storage\Exception\RuntimeException
     */
     ...
     *
     * @return \Netric\Mail\Storage\Folder instance of current folder
