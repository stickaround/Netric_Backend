...
/**
 * SMTP implementation of Netric\Mail\Protocol\AbstractProtocol
 *
...
class Smtp extends AbstractProtocol
{
     ...
     *
     * Not used by Netric\Mail, could be used to keep a connection alive or check if it is still open.
     *
     */
