...
class Part
{
     ...
     * @var string
     */
    private $type = Mime::TYPE_OCTETSTREAM;
     ...
     * @var string
     */
    private $encoding = Mime::ENCODING_8BIT;
     ...
     *
     * One of Mime::CHARSET_*
     * @var string
     */
    private $charset;

    /**
     * The boundary used to split up parts
     *
     * @var string
     */
    private $boundary;
    ...
    /**
     * Either the raw string or a handle to a stream for the part content
     *
     * @var resource|string
     */
    protected $content;
    ...
    /**
     * Flag to indicate if the part content is a stream resource
     *
     * @var bool
     */
    ...
    /**
     * Ff this was created with a stream, return a filtered stream for
