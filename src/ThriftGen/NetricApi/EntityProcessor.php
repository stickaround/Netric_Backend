...
class EntityProcessor
{
    ...
    protected function process_setEntitySeenBy($seqid, $input, $output)
    {
        ...
        if ($bin_accel) {
            $args = thrift_protocol_read_binary_after_message_begin(
                $input,
                '\NetricApi\Entity_setEntitySeenBy_args',
                $input->isStrictRead()
            );
        } else {
        ...
        $this->handler_->setEntitySeenBy($args->entityId, $args->userId, $args->accountId);
        ...
        if ($bin_accel) {
            ...
            $output->writeMessageBegin('setEntitySeenBy', TMessageType::REPLY, $seqid);
            $result->write($output);
            $output->writeMessageEnd();
            $output->getTransport()->flush();
        }
