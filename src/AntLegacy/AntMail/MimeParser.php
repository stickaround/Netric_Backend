...
// EmailParser class
require_once("src/AntLegacy/parsers/EmailReplyParser/EmailReplyParser.php");
require_once("src/AntLegacy/parsers/EmailReplyParser/Email.php");
require_once("src/AntLegacy/parsers/EmailReplyParser/Fragment.php");
require_once("src/AntLegacy/parsers/EmailReplyParser/Parser/EmailParser.php");
require_once("src/AntLegacy/parsers/EmailReplyParser/Parser/FragmentDTO.php");
// Attachment class for processing temporary attachments
require_once("src/AntLegacy/AntMail/MimeParser/Attachment.php");
