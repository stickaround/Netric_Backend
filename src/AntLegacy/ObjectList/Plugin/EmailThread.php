<?php
/**
 * Extend queries made to email_thread object types
 *
 ...
 */
require_once("src/AntLegacy/AntMail/Sync.php");

/**
 * EmailThread plugin class
 */
class AntObjectList_Plugin_EmailThread extends AntObjectList_Plugin
{
	/**
	...
	public function onQueryObjectsBefore()
	{
		...
		foreach ($accounts as $account)
		{
			...
			{
				$context = "AntObjectList_Plugin_EmailThread::onQueryObjectsBefore";
