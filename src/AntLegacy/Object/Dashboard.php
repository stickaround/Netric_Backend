...
class CAntObject_Dashboard extends CAntObject
{
	...
	{
		if (file_exists(AntConfig::getInstance()->application_path . "/public/legacy/applications/dashboards/layouts/".$appDashName.".php"))
		{
			// Layout array will be in $layout variable
			$layout = null;
			include(AntConfig::getInstance()->application_path . "/public/legacy/applications/dashboards/layouts/".$appDashName.".php");
