...
require_once("src/AntLegacy/Object/EmailThread.php");
require_once("src/AntLegacy/AntMail/DeliveryAgent.php");
require_once("src/AntLegacy/AntMail/Account.php");
require_once("src/AntLegacy/AntMail/Backend.php");
require_once("src/AntLegacy/AntMail/Parser/CssToInline.php");
...
class CAntObject_EmailMessage extends CAntObject
{
	...
	private function encodeEmbeddedAttachments($body)
	{
		...
		$arr_check = array("src=\"/antfs/images/"=>'"',
						   ...
						   "src=\"/files/images/"=>'"',
						   "src='/files/images/"=>"'",
						   "src=\"http://".$this->getAccBaseUrl(false)."/legacy/userfiles/file_download.awp?view=1&amp;fid="=>'"',
						   "src='http://".$this->getAccBaseUrl(false)."/legacy/userfiles/file_download.awp?view=1&amp;fid="=>"'");
