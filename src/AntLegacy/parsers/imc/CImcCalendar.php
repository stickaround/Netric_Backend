<?php
	require_once('src/AntLegacy/File/IMC.php');
	require_once('src/AntLegacy/File/IMC/Parse.php');
	require_once('src/AntLegacy/File/IMC/Exception.php');
	require_once('src/AntLegacy/File/IMC/Parse/Vcalendar.php');
