...
require_once("src/AntLegacy/NetricApplicationLoader.php");
...
class Ant
{
    ...
    public function __construct($account_id = null)
    {
        ...
        // Sky Stebnicki: This is a hack for backwards compatibility with old CAntObject classes
    ...
    public function settingsGet($name, $dbh = null)
    {
        ...
        $query = "select value from settings where name='$name' AND user_id is NULL";
    ...
    public function settingsSet($name, $value, $dbh = null)
    {
        ...
        if ($dbh->GetNumberRows($result)) {
            ...
            $dbh->Query("INSERT INTO settings(name, value) values('$name', '".$dbh->Escape($value)."');");
        }
    ...
    public function setAereusCustomerId($params = array(), $dbh = null)
    {
        ...
        $api = new AntApi(
            AntConfig::getInstance()->aereus['server'],
    ...
    {
        require_once("src/AntLegacy/System/SchemaUpdater.php");
    ...
    public function getAccBaseUrl($includePro = true)
    {
        ...
        } elseif (AntConfig::getInstance()->localhost_root != "localhost") {
