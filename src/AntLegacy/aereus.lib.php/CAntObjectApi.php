...
class CAntObjectApi
{
	...
	{		
		...
		$this->m_urlGet = "http://".$server."/legacy/objects/xml_get_object.php?auth=".base64_encode($username).":".md5($password)."&obj_type=".$this->obj_type;
	...
	**************************************************************************************/
	function getDefinition()
	{
		$url = "http://".$this->m_server."/legacy/objects/xml_get_objectdef.php?auth=".base64_encode($this->m_user).":".md5($this->m_pass);
