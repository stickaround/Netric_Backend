...
class CAntCustomer
{
	...
	{
		$this->m_url = "http://".$server."/legacy/customer/wapi.php?auth=".base64_encode($username).":".md5($password);
		$this->m_urlGet = "http://".$server."/legacy/objects/xml_get_object.php?auth=".base64_encode($username).":".md5($password)."&obj_type=customer";
		$this->m_values = array();
