...
require_once("src/AntLegacy/aereus.lib.php/elastic.php");
require_once("src/AntLegacy/obj_indexers/db.php");
if (defined('ANT_INDEX_SOLR_HOST'))
	require_once("src/AntLegacy/obj_indexers/solr.php");
require_once("src/AntLegacy/obj_indexers/elastic.php");
