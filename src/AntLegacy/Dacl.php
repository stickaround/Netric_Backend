...
require_once('src/AntLegacy/Dacl/Entry.php');
...
class Dacl
{
	 ...
	 *
	 * Sky Stebnicki: I'm not sure if this is really needed anymore
	...
	public function getEditLink()
	{
		...
		return "window.open('/legacy/security/dacl.php?id=".$this->id."', 'dacl_'+".$this->id.", '$params');";
	}
