...
{
	activeRTE = rte;
	window.open("/legacy/userfiles/popup_browse_files.awp?browse=1&filter=jpg:jpeg:png:gif:bmp&callback=RteInsertImage");
}
...
function RteInsertImage(fid, fname)
{
	if (fid) 
	{
		var imagePath = "/legacy/userfiles/file_download.awp?view=1&fid=" + fid;
