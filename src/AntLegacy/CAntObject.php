...
require_once("src/AntLegacy/AntObjectDefLoader.php");
require_once("src/AntLegacy/CRecurrencePattern.php");
require_once("src/AntLegacy/aereus.lib.php/CCache.php");
require_once("src/AntLegacy/CAntObjectIndex.php");
require_once("src/AntLegacy/CAntObjectView.php");
require_once("src/AntLegacy/CAntObjectCond.php");
require_once("src/AntLegacy/CAntObjectSort.php");
...
require_once("src/AntLegacy/AntObjectLoader.php");
...
class CAntObject
{
	...
	static public function factory(CDatabase $dbh, $obj_type, $id=null, $user=null, $fields_def=null, $comprev=null, $cachedata=null)
	{
		...
		if (file_exists(dirname(__FILE__)."/Object/" . $fname . ".php"))
		{
			...
			if (!class_exists($className, false))
				require_once("src/AntLegacy/Object/" . $fname . ".php");
	...
	public function setIndex($type=null)
	{
		...
		default:
            ...
            // - Sky Stebnicki
			require_once("src/AntLegacy/CAntObjectIndex.php");
			require_once("src/AntLegacy/obj_indexers/entityquery.php");
