...
class ApplicationController extends Controller
{
    ...
    */
    public function getWelImage($params)
    {
        ...
        if ($custimg)
        {
            $ret = ($custimg == "none") ? "none" : "/legacy/userfiles/getthumb_by_id.awp?fid=$custimg&stretch=1&iw=$width";
        }
        else
        {
            ...
            {
                $ret = "/legacy/userfiles/getthumb.awp?path=".base64_encode("/images/themes/".UserGetTheme($dbh, $this->user->id, 'name')."/greeting.png");
