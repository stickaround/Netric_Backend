...
class ObjectController extends Controller
{
    ...
    public function getGroupings($params)
    {
		...
		// Add conditions
		// Sky Stebnicki: I'm not sure about this code or what is using it
        $conditions = array();
    ...
    public function getForms($params)
    {
        ...
        if ($obj_type) {
            ...
            for ($i = 0; $i < $num; $i++) {
                ...
                if ($otid == $row['type_id']) {
                    $ret[] = array(
                        "type_id" => $row['type_id'], "scope" => $row['scope'], "team_id" => $row['team_id'],
    ...
    public function getPlugins($params)
    {
        ...
        $path = __DIR__ . "/../../../public/js/legacy/ObjectLoader/Plugin/" . $params['obj_type'];
        if (file_exists($path)) {
