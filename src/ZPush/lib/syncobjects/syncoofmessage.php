...
class SyncOOFMessage extends SyncObject
{
    ...
    public function __construct()
    {
        $mapping = [
            ...
            SYNC_SETTINGS_APPLIESTOINTERVAL             => [  self::STREAMER_VAR      => "appliesToInternal",
                                                                    self::STREAMER_PROP     => self::STREAMER_TYPE_SEND_EMPTY],

            SYNC_SETTINGS_APPLIESTOEXTERNALKNOWN        => [  self::STREAMER_VAR      => "appliesToExternal",
                                                                    self::STREAMER_PROP     => self::STREAMER_TYPE_SEND_EMPTY],

            SYNC_SETTINGS_APPLIESTOEXTERNALUNKNOWN      => [  self::STREAMER_VAR      => "appliesToExternalUnknown",
                                                                    self::STREAMER_PROP     => self::STREAMER_TYPE_SEND_EMPTY],
            ...
            SYNC_SETTINGS_BODYTYPE                      => [  self::STREAMER_VAR      => "bodytype",
                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_ONEVALUEOF => [SYNC_SETTINGSOOF_BODYTYPE_HTML, ucfirst(strtolower(SYNC_SETTINGSOOF_BODYTYPE_TEXT))] ]],
