...
class SyncOOF extends SyncObject
{
    ...
    {
        $mapping = [
            SYNC_SETTINGS_OOFSTATE      => [  self::STREAMER_VAR      => "oofstate",
                                                    self::STREAMER_CHECKS   => [   [   self::STREAMER_CHECK_ONEVALUEOF => [0,1,2] ]]],

            SYNC_SETTINGS_STARTTIME      => [  self::STREAMER_VAR      => "starttime",
                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_DATE_DASHES],

            SYNC_SETTINGS_ENDTIME       => [  self::STREAMER_VAR      => "endtime",
                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_DATE_DASHES],

            SYNC_SETTINGS_OOFMESSAGE    => [  self::STREAMER_VAR      => "oofmessage",
