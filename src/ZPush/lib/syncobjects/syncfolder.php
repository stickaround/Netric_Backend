...
class SyncFolder extends SyncObject
{
    ...
    {
        $mapping = [
                    SYNC_FOLDERHIERARCHY_SERVERENTRYID                  => [  self::STREAMER_VAR      => "serverid",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_REQUIRED   => false]],

                    SYNC_FOLDERHIERARCHY_PARENTID                       => [  self::STREAMER_VAR      => "parentid",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_REQUIRED   => self::STREAMER_CHECK_SETZERO]],

                    SYNC_FOLDERHIERARCHY_DISPLAYNAME                    => [  self::STREAMER_VAR      => "displayname",
                    ...
                    SYNC_FOLDERHIERARCHY_IGNORE_NOBCKENDFLD             => [  self::STREAMER_VAR      => "NoBackendFolder",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_IGNORE],

                    SYNC_FOLDERHIERARCHY_IGNORE_BACKENDID               => [  self::STREAMER_VAR      => "BackendId",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_IGNORE],

                    SYNC_FOLDERHIERARCHY_IGNORE_FLAGS                   => [  self::STREAMER_VAR      => "Flags",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_IGNORE],

                    SYNC_FOLDERHIERARCHY_IGNORE_TYPEREAL                => [  self::STREAMER_VAR      => "TypeReal",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_IGNORE],
        ];
