...
class SyncMail extends SyncObject
{
    ...
    {
        $mapping = [
                    SYNC_POOMMAIL_TO                                    => [  self::STREAMER_VAR      => "to",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_COMMA_SEPARATED,
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_LENGTHMAX      => 32768,
                                                                                                                        self::STREAMER_CHECK_EMAIL        => "" ]],

                    SYNC_POOMMAIL_CC                                    => [  self::STREAMER_VAR      => "cc",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_COMMA_SEPARATED,
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_LENGTHMAX      => 32768,
                                                                                                                        self::STREAMER_CHECK_EMAIL        => "" ]],

                    SYNC_POOMMAIL_FROM                                  => [  self::STREAMER_VAR      => "from",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_LENGTHMAX      => 32768,
                                                                                                                        self::STREAMER_CHECK_EMAIL        => "" ],
                                                                                    self::STREAMER_RONOTIFY => true],

                    SYNC_POOMMAIL_SUBJECT                               => [  self::STREAMER_VAR      => "subject",
                                                                                    self::STREAMER_RONOTIFY => true],
                    SYNC_POOMMAIL_THREADTOPIC                           => [  self::STREAMER_VAR      => "threadtopic",
                                                                                    self::STREAMER_RONOTIFY => true],
                    SYNC_POOMMAIL_DATERECEIVED                          => [  self::STREAMER_VAR      => "datereceived",
                    ...
                    SYNC_POOMMAIL_IMPORTANCE                            => [  self::STREAMER_VAR      => "importance",
                    ...
                    SYNC_POOMMAIL_ATTACHMENTS                           => [  self::STREAMER_VAR      => "attachments",
                                                                                    self::STREAMER_TYPE     => "SyncAttachment",
                                                                                    self::STREAMER_ARRAY    => SYNC_POOMMAIL_ATTACHMENT],

                    SYNC_POOMMAIL_MIMETRUNCATED                         => [  self::STREAMER_VAR      => "mimetruncated",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_ZEROORONE      => self::STREAMER_CHECK_SETZERO]],

                    SYNC_POOMMAIL_MIMEDATA                              => [  self::STREAMER_VAR      => "mimedata",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_STREAM_ASPLAIN],

                    SYNC_POOMMAIL_MIMESIZE                              => [  self::STREAMER_VAR      => "mimesize",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_CMPHIGHER      => -1]],

                    SYNC_POOMMAIL_BODYTRUNCATED                         => [  self::STREAMER_VAR      => "bodytruncated",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_ZEROORONE      => self::STREAMER_CHECK_SETZERO]],

                    SYNC_POOMMAIL_BODYSIZE                              => [  self::STREAMER_VAR      => "bodysize",
                                                                                    self::STREAMER_CHECKS   => [   self::STREAMER_CHECK_CMPHIGHER      => -1]],

                    SYNC_POOMMAIL_BODY                                  => [  self::STREAMER_VAR      => "body"],
                    SYNC_POOMMAIL_MESSAGECLASS                          => [  self::STREAMER_VAR      => "messageclass"],
                    SYNC_POOMMAIL_MEETINGREQUEST                        => [  self::STREAMER_VAR      => "meetingrequest",
                                                                                    self::STREAMER_TYPE     => "SyncMeetingRequest"],

                    SYNC_POOMMAIL_REPLY_TO                              => [  self::STREAMER_VAR      => "reply_to",
        ...
        if (Request::GetProtocolVersion() >= 14.0) {
            ...
            $mapping[SYNC_POOMMAIL2_LASTVERBEXECUTIONTIME]              = [   self::STREAMER_VAR      => "lastverbexectime",
                                                                                    self::STREAMER_TYPE     => self::STREAMER_TYPE_DATE_DASHES];
            ...
            $mapping[SYNC_POOMMAIL_CATEGORIES]                          = [   self::STREAMER_VAR      => "categories",
